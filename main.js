...
function draw(){
    ...
    document.getElementById("song_playing").innerHTML=" Name of song playing : Harry Potter Theme Song"
    ...
    if(scoreleftwrist>0.2){
        ...
        song2.rate(1);
        song.stop();
        document.getElementById("song_playing").innerHTML=" Name of song playing : Peter Pan"
